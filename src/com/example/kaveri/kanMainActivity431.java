...
public class kanMainActivity431 extends Activity {
	Button bt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.kanbuydet1);
        ...
        bt.setOnClickListener(new OnClickListener()
    	{
			public void onClick(View v) 
			{
				...
				amt*=qty;
				Intent intent=new Intent(getApplicationContext(),kanMainActivity441.class);
				Bundle b = new Bundle();
				b.putString("name",name);
				b.putString("prod", prod);
				b.putString("addr", addr);
				b.putInt("amt", amt);
				b.putInt("image",R.drawable.e11);
				intent.putExtras(b);
