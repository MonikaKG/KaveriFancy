...
public class Purchasedes extends Activity
{
	Button bt;
	VivzDatabaseAdapter vivzhelper;
	 ...
	 @Override
	    protected void onCreate(Bundle savedInstanceState) {
	        ...
	        setContentView(R.layout.purchasedes);
	        ...
	        bt.setOnClickListener(new View.OnClickListener() 
	        {
		         ...
		         String pass="Pass :"+sp.getString("Pass",null);
	        	...
	        	// Toast.makeText(getApplicationContext(),result,Toast.LENGTH_LONG).show();	
		         Intent in = new Intent(getApplicationContext(),MainActivity43.class);
